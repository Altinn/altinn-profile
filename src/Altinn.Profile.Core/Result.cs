...
public readonly struct Result<TValue, TError>
{
    ...
    /// This method will call either the success OR the failure function based on it's error state.
    /// </summary>
    /// <param name="success">The action to perform if Result holds a success value.</param>
    /// <param name="failure">The action to perform if Result holds an error value.</param>

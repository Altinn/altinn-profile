...
namespace Altinn.Profile.Core.AddressVerifications
{
    ...
    public interface IAddressVerificationService
    {
        ...
        /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
        /// <returns>A Task containing the <see cref="VerificationType"/> or null if no address.
        ...
        Task<ResendVerificationResult> ResendVerificationCodeAsync(int userId, string address, AddressType addressType, CancellationToken cancellationToken);
    }
}

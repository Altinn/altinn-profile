...
/// <summary>
/// Handler for the event where the user updates their private contact information (email and/or phone number).
/// </summary>
/// <remarks>
...
public class SiUserContactInfoUpdatedHandler(IPrivateConsentProfileClient privateConsentProfileClient, IOptions<SblBridgeSettings> settings)
{
    ...
    /// </summary>
    [Transactional]
    public async Task Handle(SiUserContactInfoUpdatedEvent changeEvent)
    {
        if (!_updateA2)
        {
            return;

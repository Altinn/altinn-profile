-- Scrips generated by "dotnet ef migrations script --idempotent --startup-project ../Altinn.Profile"
...
CREATE TABLE organization_notification_address.notifications_address (
    ...
    created_date_time timestamp with time zone NOT NULL DEFAULT (now() at time zone 'utc'),

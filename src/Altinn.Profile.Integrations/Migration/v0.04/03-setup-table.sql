...
CREATE TABLE organization_notification_address.notifications_address (
    ...
    fk_registry_organization_id integer,
    CONSTRAINT contact_info_pkey PRIMARY KEY (contact_info_id),
    CONSTRAINT fk_notifications_address_organizations_fk_registry_organizatio FOREIGN KEY (fk_registry_organization_id) REFERENCES organization_notification_address.organizations (registry_organization_id)
);

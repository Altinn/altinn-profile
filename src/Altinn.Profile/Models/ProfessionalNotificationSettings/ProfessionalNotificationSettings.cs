...
namespace Altinn.Profile.Models.ProfessionalNotificationSettings
{
    ...
    public abstract partial class ProfessionalNotificationSettings : IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("ResourceIncludeList must contain valid URN values of the format 'urn:altinn:resource:{resourceId}' where resourceId has 4 or more characters of letter, number, underscore or hyphen", [nameof(ResourceIncludeList)]);
            }

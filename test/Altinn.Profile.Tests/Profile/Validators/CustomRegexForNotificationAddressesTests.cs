...
namespace Altinn.Profile.Tests.Profile.Validators
{
    public class CustomRegexForNotificationAddressesTests
    {
        ...
        {
            var attribute = new CustomRegexForNotificationAddressesAttribute(ValidationRule.PhoneNumber);
        ...
        {
            var attribute = new CustomRegexForNotificationAddressesAttribute(ValidationRule.EmailAddress);
        ...
        {
            var attribute = new CustomRegexForNotificationAddressesAttribute(ValidationRule.OrganizationPhone);
        ...
        {
            var attribute = new CustomRegexForNotificationAddressesAttribute(ValidationRule.OrganizationCountryCode);
        ...
        {
            var attribute = new CustomRegexForNotificationAddressesAttribute(ValidationRule.OrganizationEmail);
